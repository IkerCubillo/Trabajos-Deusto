...
public class EjemploJavaFuncional {
	int x;
	int y;
//	int funcion = funcion;
	...
	public static void main(String[] args) {
		...
		boton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) { // objeto de clase anónima que implementa ActionLister
				// TODO Auto-generated method stub
				System.out.println("hola");
			}
		});
		boton.addActionListener(new MiEsc()); // objeto de clase no anónima que implementa ActionLister
		
		// Java8
		boton.addActionListener(
			(ActionEvent e) -> {System.out.println("hola"); }
			// ActionListener
		);
		...
		// No se puede mostrar si son varios métodos
