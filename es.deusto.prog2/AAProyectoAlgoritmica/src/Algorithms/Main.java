...
public class Main {
	...
	static int[] lis = {21,3,3123,32,56,1};
	...
	public static void main(String args[]){
		...
		// Execution of Insert Sort algorithm
		for (int i = 0; i < 3; i++) {
		    ...
		    System.out.println("The Insert Sort algorithm with an array of " + limite.get(i) +	// Printing the time results
		...
		for (int i = 0; i < 3; i++) {
		    ...
		    System.out.println("The Insert Sort algorithm with an array of " + limite.get(i) +
		    					" elements took " + (end1-start1) + " nanoseconds to execute, or " + ((end1-start1)*0.000001) + " miliseconds" );
		}
		System.out.println();
		...
		for (int i = 0; i < 3; i++) {
			Algorithm obj = new Algorithm();
			long start1 = System.nanoTime();
			obj.countingSort(listas.get(i), listas.get(i).size());
			long end1 = System.nanoTime();
