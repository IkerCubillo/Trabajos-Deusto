...
public class Coche extends Vehiculo {
	...
	public Coche(String modelo, String color, String llanta, String interior, boolean pilotoAutomatico, boolean repuestoGratuito) {
	...
	int getPrecio() {
		...
		} else if(getColor().equals("blanco")){
			precio += 1050;
		} else {
			precio += 2100;
		}
